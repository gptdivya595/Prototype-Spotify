...
function fallbackCandidate(text: string): z.infer<typeof rawCandidateSchema> {
  ...
  return {
    ...
    novelty: adventurous ? 0.82 : familiar ? 0.25 : 0.5,
    excludeArtistIds: [],
    excludeGenres: [],
    excludeLanguages: [],
    unresolvedTerms: []
      ...
      response_format: {
        ...
        json_schema: {
          ...
          schema: {
            ...
            required: ["activity", "moods", "genres", "languages", "energy", "novelty", "excludeArtistIds", "excludeGenres", "excludeLanguages", "unresolvedTerms"],
            properties: {
